...
public class BrowserUtils {
	...
	// create a method which accepts a WebElement, which selects by visible text (class exercise)
	...
	// this method generate 3 digit random number
		...
		// JS executor highlights element 
		
	//	public void highlightElement() {
	//		is = (JavascriptExecutor) Driver.getDriver();
	//		js.executeScript("arguments[0].style.border='3px red' ", element);
	//	}
		
		
	// create a utility method that accepts Alert
	   // create a method that has a WebDriver as a parameter and does the alert accept
